...
if ($shopifyResult['success']) {
    ...
    $shopifyProductId = $shopifyResult['data']['id'];
    ...
    /*
     * Update Shopify price, original price and SKU.
     */
    ...
    if (
        ...
        $message =
            'Product created successfully and synced to Shopify.';
        ...
        $message =
            'Product created locally and Shopify product created, but some Shopify data failed to sync.';
    ...
    /*
     * Local product remains saved even if Shopify fails.
     */
    $message =
        'Product created locally, but Shopify synchronization failed.';
